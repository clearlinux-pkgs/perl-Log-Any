...
Source0  : https://cpan.metacpan.org/authors/id/P/PR/PREACTION/Log-Any-1.706.tar.gz
...
%package man
Summary: man components for the perl-Log-Any package.
Group: Default

%description man
man components for the perl-Log-Any package.


%prep
tar -xf %{SOURCE1}
cd ..
%setup -q -n Log-Any-1.706
mkdir -p %{_topdir}/BUILD/Log-Any-1.706/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Log-Any-1.706/deblicense/
