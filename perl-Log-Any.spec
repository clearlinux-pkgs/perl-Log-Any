...
Source0  : https://cpan.metacpan.org/authors/id/P/PR/PREACTION/Log-Any-1.718.tar.gz
...
%prep
%setup -q -n Log-Any-1.718
cd %{_builddir}/Log-Any-1.718
pushd ..
cp -a Log-Any-1.718 buildavx2
popd
