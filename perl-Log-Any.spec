...
Source0  : https://cpan.metacpan.org/authors/id/P/PR/PREACTION/Log-Any-1.710.tar.gz
...
%prep
%setup -q -n Log-Any-1.710
cd %{_builddir}
tar xf %{_sourcedir}/liblog-any-perl_1.705-1.debian.tar.xz
cd %{_builddir}/Log-Any-1.710
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Log-Any-1.710/deblicense/
...
cp %{_builddir}/Log-Any-1.710/LICENSE %{buildroot}/usr/share/package-licenses/perl-Log-Any/89617cd16eccd37ac271de8c18ac6e5f645f700e
